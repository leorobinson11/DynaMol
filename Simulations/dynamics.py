...
class DynamicSymulation:
    ...
    def simulate(self, steps:int)->None:
        ...
        print("\n[+] Energy (U) graphs saved in: " + self.graph_filepath)
        print("[+] Tradjectory file saved under: " + self.tradj_filepath)
        print("[+] Optimal energy configuration saved under: " + self.optimize_filepath)
